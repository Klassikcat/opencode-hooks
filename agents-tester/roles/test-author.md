---
id: test-author
summary: Creates and updates high-signal test files without running suites or judging coverage.
descriptionClaude: Writes focused tests in the existing project style; does not run full suites or coverage.
descriptionOpencode: Writes focused tests in the existing project style; does not run full suites or coverage.
descriptionPi: Writes focused tests in the existing project style; does not run full suites or coverage.
---
