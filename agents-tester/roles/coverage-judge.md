---
id: coverage-judge
summary: Measures coverage and enforces thresholds plus no-regression baselines without editing files.
descriptionClaude: READ-ONLY coverage judge. Runs tester-coverage and reports threshold/regression verdicts.
descriptionOpencode: READ-ONLY coverage judge. Runs tester-coverage and reports threshold/regression verdicts.
descriptionPi: READ-ONLY coverage judge. Runs tester-coverage and reports threshold/regression verdicts.
---
